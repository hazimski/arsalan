...
export default function Chatbot() {
    ...
    useEffect(() => {
        window.addEventListener('message', function (event) {
            var iframe = document.getElementById('chatpad-chatbot-iframe');
            var buttonIframe = document.getElementById('chatpad-chatbot-button-iframe');
    ...
    function Chatbox() {
        ...
        if ((params.get('chatbox') || '').match('false')) {
            ...
            return (
                <>
                    <iframe
                        src={`/embed/clxc85c4h0003vo7g2o8vdgam/button?chatbox=false`}
                        scrolling='no'
                        id="chatpad-chatbot-button-iframe"
                    ...
                    ></iframe>
                    <iframe
                        src={`/embed/clxc85c4h0003vo7g2o8vdgam/window?chatbox=false&withExitX=true`}
                        style={customStyle}
                        allowFullScreen
                        className='z-50'
                        id="chatpad-chatbot-iframe"
                    ></iframe>
                </>
            )
        }
